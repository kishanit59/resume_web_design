...
export const DATA = {
  ...
  skills: [
    ...
    "Next.js",
    "Strapi CMS",
    "Bagisto Extension Development",
    "Bagisto E-commerce store setup",
    "Solidity",
    "NFT Minting",
